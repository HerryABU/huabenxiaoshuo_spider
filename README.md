...
距离上一版本发布已经有一段时间了，这次带来了**话本小说网通用爬虫 v3.0**的重大更新！完全重写了GUI界面，优化了布局，新增了大量实用功能。无论你是技术小白还是爬虫爱好者，都能轻松上手！

## 二、更新亮点

### ✨ 全新特性

1. **URL智能补全** - 再也不用纠结输入格式
2. **横向布局优化** - 告别纵向滚动，一屏全览
3. **作者信息展示** - 开源免费，拒绝贩卖
4. **常见问题解答** - 内置FAQ，即查即用
5. **免责声明** - 合法使用，尊重版权
6. **日志过滤增强** - 级别+关键词双重过滤
...
└─────────────────────────────────────────────────┘
```
![截图](https://i-blog.csdnimg.cn/direct/3c191384c4e546a883c2f4b7b575ec13.png)
...
### Q: 是否收费？
**A**: 这是**开源免费**的软件！如果你是从任何渠道购买的，说明你上当受骗了！欢迎到GitHub免费下载。
...
1. **输入URL**：粘贴小说目录页链接
2. **获取信息**：点击"获取信息"查看书籍详情
3. **选择格式**：MD/TXT/独立章节/JSON
4. **开始下载**：点击"开始下载"，实时查看进度
5. **完成**：自动提示打开文件夹
